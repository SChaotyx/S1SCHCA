...
; ---------------------------------------------------------------------------
		...
		dc.w SonAni_ElecHurt-SonicAniData		;$23
; ---------------------------------------------------------------------------
...
SonAni_SpeelOut:    dc.b 0, 8, 8, 8, 8, 8, 8, 9, 9, 9, 9, 9, $A, $A, $A, $A, $B, $B, $B, 6, 6, 6, 7, 7, 7 			; 24 frames slow walk
					dc.b 8, 8, 8, 9, 9, $A, $A, $B, $B, 6, 6, 7 													; 36 frames fast walk
					dc.b $1E, $1E, $1F, $1F, $20, $20, $21, $21, $1E, $1F, $20, $21, $1E, $1F, $20, $21				; 52 frames run
					dc.b $5E, $5E, $5F, $5F, $60, $60, $61, $61, $FE, 8, 0 											; 60 frames peelout
SonAni_SpeelOutUW:  dc.b 0, 8, 8, 8, 8, 8, 8, 9, 9, 9, 9, 9, $A, $A, $A, $A, $B, $B, $B, 6, 6, 6, 7, 7, 7   		; 24 frames walk
...
SonAni_ElecHurt:	dc.b 2, $6F, $70, $FF
		even
; ---------------------------------------------------------------------------
